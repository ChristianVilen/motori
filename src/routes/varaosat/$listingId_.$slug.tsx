...
function PartDetailPage() {
	const { listing, part, images, session, makeName, makeSlug, modelName, ownerReviewSummary, ownerContact } =
		Route.useLoaderData();
	const { t } = useTranslation("listings");
	...
	return (
		<ListingDetailShell
			data={{ listing, rental: null, sale: null, gear: null, part, images, makeName, makeSlug, modelName, ownerReviewSummary, ownerContact }}
			session={session}
			backTo="/varaosat"
